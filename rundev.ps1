...
$services = @("mongodb","postgres","valkey","cache-postgres","lavalink","api-backend","osrs-cache-service","cache-tiles","discord-server","discord-utils","discord-event") + $ExtraServices
